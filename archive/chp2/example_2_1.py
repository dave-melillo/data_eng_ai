...
orders = [
    {
        ...
        "status": "completed",
        "products": [
            {"description": "Nike Air Max - Red", "price": 120.00, "quantity": 1},
            {"description": "Adidas Ultraboost - Black", "price": 150.00, "quantity": 2}
        ]
    },
    {
        "order_id": 2,
        "status": "pending",
        "products": [
            {"description": "Puma Speedcat - White", "price": 90.00, "quantity": 3}
        ]
    },
    {
        "order_id": 3,
        "status": "canceled",
        "products": [
            {"description": "Reebok Classic - Blue", "price": 100.00, "quantity": 1}
        ]
    }
]
...
rows = []
for order in orders:
    if order['status'] != 'canceled':  # Skip canceled orders
